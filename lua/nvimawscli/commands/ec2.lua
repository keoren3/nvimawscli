...
function M.describe_instance_monitoring(instance_id, current_time, hours, interval, on_result)
	...
	local metric_data_queries = itertools.imap_values(preferred_metrics, function(metric)
		return '{"Id":"'
			.. string.lower(metric)
			.. '", "MetricStat":{'
...
-- aws cloudwatch list-dashboard (maybe creating dashboards would be interesting)
return M
